  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/v1/login' element={<PublicOnlyRoute><Login/></PublicOnlyRoute>} /> {/* opción 1 de sintaxis */}
        <Route path='/v1/signup' element={<PublicOnlyRoute><SignUp/></PublicOnlyRoute>} />      {/* opción 2 de sintaxis */}
        ...
        <Route path='/v1/cart/checkoutRespaldo' element={<PrivateRoute><CheckoutRespaldo/></PrivateRoute>}></Route>
